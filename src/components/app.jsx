...
const MyApp = () => {
  ...
  const alertLoginData = () => {
    // Framework7.request.post("http://localhost/BACKEND_BELAJAR_FRAMEWORK_7/login.php", {
    //   "username": username,
    //   "password": password
    // }).then(function (data){
    //   console.log(data);
    ...
    // })
    fetch('http://localhost/BACKEND_BELAJAR_FRAMEWORK_7/login.php', {            
      method: 'POST',
      headers: {
  ...
  f7ready(() => {
    ...
    // Call F7 APIs here
    console.log(localStorage.getItem("status"), "<<<<status??")
